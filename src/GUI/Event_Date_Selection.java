...
public class Event_Date_Selection extends javax.swing.JFrame {
    ...
    public static String selectedEventDate;

    /**
     * Creates new form Event_Date_Selection
     */
    public Event_Date_Selection() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setText("Set Time Of Event");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jCalendar1, javax.swing.GroupLayout.DEFAULT_SIZE, 470, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Event_Date_Selection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Event_Date_Selection().setVisible(true);
            }
        });
    }
